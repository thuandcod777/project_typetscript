...
export class ProductModel {
    ...
    constructor({ nameProduct = "", typeProduct = "Select Type Product", amount = 0, width = 0, height = 0, weight = 0, length = 0, index = 0 }: Partial<ProductModel> = {}) {
    ...
    static fromJson(json: IProductJSON): ProductModel {
...
export class AddressTakeGoodsModel {
    method: string;
    address: string;
    scope: string;

    constructor({ method = "", address = "", scope = "Select Scope" }: Partial<AddressTakeGoodsModel> = {}) {
        this.method = method;
        this.address = address;
        this.scope = scope;
    }

    static fromJson(json: IAddressJSON): AddressTakeGoodsModel {
        return new AddressTakeGoodsModel({
            method: json.method,
...
export class PaymentModel {
    ...
    constructor({ typePayment = "", stepPayment = 0 }: Partial<PaymentModel> = {}) {
        this.typePayment = typePayment;
        this.stepPayment = stepPayment;
    }

    static fromJson(json: IPaymentJSON): PaymentModel {
...
export default class OrderModel {
    ...
    readonly statusPickTime: boolean;
    readonly product: ProductModel;
    readonly addressTakeGoods: AddressTakeGoodsModel;
    readonly addressDelivery: AddressDeliveryModel;
    ...
    constructor({
        ...
        payment }: {
            ...
            addressTakeGoods: AddressTakeGoodsModel;
    ...
    static fromJson(json: any): OrderModel {
        return new OrderModel({
            ...
            statusDelivery: json.status_delivery || json.statusDelivery, // Hỗ trợ cả snake_case từ DB
            statusPickTime: json.status_pick_time ?? json.statusPickTime,
            product: ProductModel.fromJson(json.product),
            addressTakeGoods: AddressTakeGoodsModel.fromJson(json.address_take_goods || json.addressTakeGoods),
            addressDelivery: AddressDeliveryModel.fromJson(json.address_delivery || json.addressDelivery),
